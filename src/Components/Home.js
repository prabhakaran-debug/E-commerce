...
import addtocart from '../Components/image/addtocart.png'
import NavbarComponent from "./Navbar";
import { red } from "@mui/material/colors";
import ecommerce_banner from '../Components/image/banner.jpg'
...
function Home() {
    ...
    const [cartcout, setCartcount] = useState(0); // Cart count state
    const [quantity, setQuantity] = useState({}); // Changed quantity state to store per product
